...
import { LayoutDashboard, Users, Package, Tags, Gift, Activity, LogOut, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col md:flex-row font-sans text-slate-200 bg-transparent">
      ...
      <div className="md:hidden glass-panel rounded-none border-b border-white/10 p-4 flex justify-between items-center z-20 sticky top-0">
        <div>
          ...
          <span className="text-[10px] font-semibold text-brand-500 uppercase tracking-wider">Manager Portal</span>
        </div>
        ...
        <nav className="flex-1 px-4 space-y-2 mt-4 overflow-y-auto">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={`w-5 h-5 mr-3 shrink-0 ${isActive ? 'text-brand-400' : 'text-slate-500'}`} />
        ...
        <div className="p-4 border-t border-white/10 bg-black/20 mt-auto">
          <div className="flex items-center gap-3 px-4 py-3 mb-2">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-brand-400 truncate">Store Manager</p>
            </div>
          </div>
